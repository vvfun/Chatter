        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, okhttp3.Response response) {
                try {
                    ...
                    Response<HashMap<String, String>> basicResponse = new Gson().fromJson(resStr, new TypeToken<Response<HashMap<String, String>>>() {
                    }.getType());
                    HashMap<String, String> map = basicResponse.getData();
                    if (map == null) {
                        return;
                    }
